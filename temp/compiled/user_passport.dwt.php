...
<?php echo $this->smarty_insert_scripts(array('files'=>'common.js,user.js,transport.js,jquery.min.js')); ?>
</head>
<body>
...
<div class="usBox clearfix">
  <div class="usBox_1 f_l">
   ...
   <form name="formLogin" action="user.php" method="post" id='formLogin'>
        <table width="100%" border="0" align="left" cellpadding="3" cellspacing="5">
          ...
          <tr>
            <td>&nbsp;</td>
            <td align="left">
            <input type="button" class="us_Submit"  value='1'/>            </td>
          </tr>
	  <tr><td></td><td><a href="user.php?act=qpassword_name" class="f3">密码问题找回密码</a>&nbsp;&nbsp;&nbsp;<a href="user.php?act=get_password" class="f3">邮件找回密码</a></td></tr>
      </table>
    </form>
</div>
<?php endif; ?>
  ...
  <div class="usBox_2 clearfix">
    <form action="user.php" method="post" name="getPassword2" onSubmit="return submitPwd()">
      ...
      <table width="80%" border="0" align="center">
        <tr>
          <td style=" text-align:right"><?php echo $this->_var['lang']['new_password']; ?>:</td>
          <td><input name="new_password" type="password" size="25" class="inputBg" /></td>
        </tr>
        <tr>
          <td style=" text-align:right"><?php echo $this->_var['lang']['confirm_password']; ?>:</td>
  ...
  $('.us_Submit').click(function(){
   ...
   /* $.ajax({
        ...
        success:function(mdata){
          if(mdata.meta.code!=200){
            alert(mdata.meta.message);
          }else{
            window.location.href=mdata.meta.url;
          }
        }
    });*/
    //requestServer('./user.php?act=act_login',data,'post');
  });
</script>
</html>
