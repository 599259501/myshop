...
<script type="text/javascript" src="themes/ecmoban_benlai2015/js/action.js"></script>
...
?>
      ...
      <li class="clearfix">
       ...
       <strong><?php echo $this->_var['lang']['goods_brand']; ?></strong><?php echo $this->_var['goods']['goods_brand']; ?>
...
?>
                        ...
                        <?php else: ?>
                        <select name="spec_<?php echo $this->_var['spec_key']; ?>" oninput="changePrice()" >
                          <?php $_from = $this->_var['spec']['values']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'value');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['value']):
?>
...
?>
      ...
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
       ...
       <strong><?php echo $this->_var['lang']['number']; ?>：</strong>
        <input name="number" type="text" id="number" value="1" size="4" oninput="changePrice()" style="border:1px solid #ccc; position:relative; top:2px"/> <strong><?php echo $this->_var['lang']['amount']; ?>：</strong><font id="ECS_GOODS_AMOUNT" class="f1"></font>
       </dd>
       </li>
      
      <li class="padd">
      <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)"><img src="themes/ecmoban_benlai2015/images/goumai2.gif" /></a>
...
?>
          ...
          <strong><?php echo $this->_var['lang']['then_old_price']; ?></strong><font class="shop"><?php echo $this->_var['package_goods']['saving']; ?></font><br />
					...
					<td bgcolor="#FFFFFF">
					<a href="javascript:addPackageToCart(<?php echo $this->_var['package_goods']['act_id']; ?>)" style="background:transparent"><img src="themes/ecmoban_benlai2015/images/bnt_buy_1.gif" alt="<?php echo $this->_var['lang']['add_to_cart']; ?>" /></a>
					</td>
				</tr>
	    </table>
       <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
