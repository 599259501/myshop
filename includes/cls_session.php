...
class cls_session
{
    ...
    function __construct(&$db, $session_table, $session_data_table, $session_name = 'PHPSESSID', $session_id = '')
    {
        $this->cls_session($db, $session_table, $session_data_table, $session_name, $session_id);
    }

    function cls_session(&$db, $session_table, $session_data_table, $session_name = 'PHPSESSID', $session_id = '')
    {
